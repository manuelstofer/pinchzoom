...
"-o-transform":a,"-ms-transform":a,"-moz-transform":a,transform:d})):(this.is3d&&(this.clone=this.el.clone(),this.clone.css("pointer-events","none"),this.clone.appendTo(this.container),setTimeout(b,200)),this.el.css({"-webkit-transform":a,"-o-transform":a,"-ms-transform":a,"-moz-transform":a,transform:a}),this.is3d=!1)}.bind(this),0))},enable:function(){this.enabled=!0},disable:function(){this.enabled=!1}};var l=function(a,b){var c=null,d=0,e=null,f=null,h=function(a,d){if(c!==a){if(c&&!a)switch(c){case "zoom":b.handleZoomEnd(d);
break;case "drag":b.handleDragEnd(d)}switch(a){case "zoom":b.handleZoomStart(d);break;case "drag":b.handleDragStart(d)}}c=a},k=function(a){2===d?h("zoom"):1===d&&b.canDrag()?h("drag",a):h(null,a)},g=function(a){return Array.prototype.slice.call(a).map(function(a){return{x:a.pageX,y:a.pageY}})},n=function(a,b){var c,d;c=a.x-b.x;d=a.y-b.y;return Math.sqrt(c*c+d*d)},l=function(a,b){var c=n(a[0],a[1]);return n(b[0],b[1])/c},m=!0;a.addEventListener("touchstart",function(a){if(b.enabled){m=!0;d=a.touches.length;
var f=(new Date).getTime();1<d&&(e=null);if(300>f-e)switch(a.stopPropagation(),a.preventDefault(),b.handleDoubleTap(a),c){case "zoom":b.handleZoomEnd(a);break;case "drag":b.handleDragEnd(a)}1===d&&(e=f)}});a.addEventListener("touchmove",function(a){if(b.enabled){if(m)k(a),c&&(a.stopPropagation(),a.preventDefault()),f=g(a.touches);else{switch(c){case "zoom":b.handleZoom(a,l(f,g(a.touches)));break;case "drag":b.handleDrag(a)}c&&(a.stopPropagation(),a.preventDefault(),b.update())}m=!1}});a.addEventListener("touchend",
function(a){b.enabled&&(d=a.touches.length,k(a))})};return f};"undefined"!==typeof define&&define.amd?define(["jquery"],function(e){return g(e)}):(window.RTP=window.RTP||{},window.RTP.PinchZoom=g(window.$));(function(e){e.fn.pinchzoom=function(e){e=e||{};return this.each(function(){new RTP.PinchZoom(this,e)})}})(jQuery)}).call(this);
